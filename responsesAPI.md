...
- [Python (API Key)](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=rest-api#tabpanel_1_python-key)
- [Python (Microsoft Entra ID)](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=rest-api#tabpanel_1_python-secure)
- [REST API](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=rest-api#tabpanel_1_rest-api)
- [Output](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=rest-api#tabpanel_1_output)

To retrieve a response from a previous call to the responses API.

- [Python (API Key)](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=rest-api#tabpanel_2_python-key)
- [Python (Microsoft Entra ID)](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=rest-api#tabpanel_2_python-secure)
- [REST API](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=rest-api#tabpanel_2_rest-api)
- [Output](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=rest-api#tabpanel_2_output)
...
To create a container, specify `"container": { "type": "auto", "file_ids": ["file-1", "file-2"] }` in the tool configuration when creating a new Response object. This automatically creates a new container or reuses an active one from a previous code\_interpreter\_call in the model’s context. The `code_interpreter_call` in the output of the APIwill contain the `container_id` that was generated. This container expires if it is not used for 20 minutes.
